...
export function usePublishSubscriberMutation(
  ...
  return Apollo.useMutation<
    PublishSubscriberMutation,
    PublishSubscriberMutationVariables
  >(PublishSubscriberDocument, options);
}
export type PublishSubscriberMutationHookResult = ReturnType<
  typeof usePublishSubscriberMutation
>;
export type PublishSubscriberMutationResult =
  Apollo.MutationResult<PublishSubscriberMutation>;
