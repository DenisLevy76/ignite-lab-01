...
export const ExtensionLinkComponent: React.FC<ExtensionLinkComponentProps> = ({
  ...
  return (
    <a
      href={href}
      className="flex bg-grey-700 hover:bg-grey-600 rounded overflow-hidden cursor-pointer w-full justify-between text-center"
    >
      <div className="flex px-6 bg-green-500 items-center justify-center">
        {icon}
      </div>
